...
@Scope("prototype")
public class UserDeptController extends AbstractBaseController {
	...
	public String getDeptEditPage(DeptEntity dept, String parentName,
		...
		return "admin/userDept/dept_edit";
	}
	...
	public String getUserQueryPage(Page page, BindingResult bindingResult,String id) {
		request.setAttribute("selectId", id);
		request.setAttribute("selectType", "3");
		return "admin/userDept/user_dept_query";
	}
	/**
	 * 进入部门单选页面
	 * 
	...
	public String getOneDeptQueryPage(DeptEntity entity,
		...
		return "admin/userDept/dept_radio_page";
	}
	...
	public String getDeptTreeQueryPage() {
		return "admin/userDept/dept_tree_query";
	}
