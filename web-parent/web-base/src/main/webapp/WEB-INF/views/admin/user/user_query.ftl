...
// 			window.open("/admin/user/getUserEditPage?id="+id);
			var toolTip = new Layer({
		        ...
		        callback:function(){		        	
		        	$(".layerContianer").load('/admin/user/getUserEditPage?id='+id,{},function(){});
		        }
		    });
		    toolTip.show();
		});
		...
		$(document).on("click",".resetPassword",function(){
			...
			var toolTip = new Layer({
		        ...
		        callback:function(){		        	
		        	$(".layerContianer").load('/admin/user/getPasswordResetPage?id='+id,{},function(){});
		        }
		    });
		    toolTip.show();
		...
		$(document).on("click",".userRoleAssignment",function(){
	    	var that = this;
			var id = $(that).attr("id");
// 			window.open("/admin/user/getUserRoleAssignmentPage?id="+id);
			var toolTip = new Layer({
		        ...
		        callback:function(){		        	
		        	$(".layerContianer").load('/admin/user/getUserRoleAssignmentPage?id='+id,{},function(){});
		        }
		    });
		    toolTip.show();
		});
		$(document).on("click",".userDeptAssignment",function(){
	    	var that = this;
			var id = $(that).attr("id");
// 			window.open("/admin/user/getUserDeptAssignmentPage?id="+id);
			var toolTip = new Layer({
		        ...
		        callback:function(){		        	
		        	$(".layerContianer").load('/admin/user/getUserDeptAssignmentPage?id='+id,{},function(){});
		        }
		    });
		    toolTip.show();
		});
...
// 			window.open("/admin/menu/getMenuCenterAssignmentPage?relationType=1&relationId="+id);
			var toolTip = new Layer({
		        ...
		        setOverflow:"overflow-y:scroll",
		        callback:function(){		        	
		        	$(".layerContianer").load('/admin/menu/getMenuCenterAssignmentPage?relationType=1&relationId='+id,{},function(){});
		        }
		    });
		    toolTip.show();
		});
...
// 			window.open("/admin/user/getUserRoleAssignmentPage?id="+id);
			var toolTip = new Layer({
		        ...
		        width:500,
		        height:400,
		        alerttit:"<@i18n.messageText code='user.management.button.excel.batch.upload'  text='excel批量上传' />",
		        callback:function(){		        	
		        	$(".layerContianer").load('/admin/files/getOneFileUploadPage',{},function(){});
		        }
		    });
		    toolTip.show();
		});
  	...
  	///admin/user/exportUserInfo
	$("#exportUser").click(function(){
		var a = $("#form_file").serialize();
// 		location.href = "/admin/user/exportUserInfo?"+a;
        ...
        var qm_data = 'search.realName=' + search_realName + '&search.userName=' + search_userName + '&search.loginStatus=' + search_loginStatus;
     	// 导出
        location.href = '/admin/user/exportUserInfo?'+qm_data;
	...
	var tabSort = new tableSort({sortClass:".sorting",callback:function(sortName,sortType){
    	...
    	var search_userName = $("[id='search.userName']").val();
    	var search_loginStatus = $("[id='search.loginStatus']").val();
    	var qm_url = "/admin/user/findPage?orderBy= "+sortName+" "+sortType;
    	var nowPageSize = $("#limitpagenum").val();
    	var qm_data = {pageSize:nowPageSize,'search.realName':search_realName,'search.userName':search_userName,'search.loginStatus':search_loginStatus};
...
//     	window.open("/admin/user/getUserEditPage");
    	var toolTip = new Layer({
	        ...
	        callback:function(){		        	
	        	$(".layerContianer").load('/admin/user/getUserEditPage',{},function(){});
	        }
	    });
	    toolTip.show();
    });
